...
for ($i=1; $i<=$jmlhalaman; $i++){
  ...
  $link_halaman .= "<a href=$_SERVER[PHP_SELF]?module=$_GET[module]&submenu=$subb&halaman=$i>$i</a> | ";
}
$link_halaman .= " ";
}
return $link_halaman;
...
for ($i=1; $i<=$jmlhalaman; $i++){
  ...
  $link_halaman .= "<a href=halalbum-$_GET[id]-$i.html>$i</a> | ";
}
$link_halaman .= " ";
}
return $link_halaman;
...
// Fungsi untuk mencek halaman dan posisi data
function cariPosisi($batas){
if(empty($_GET[halbiodata])){
	$posisi=0;
	$_GET[halbiodata]=1;
}
else{
	$posisi = ($_GET[halbiodata]-1) * $batas;
}
return $posisi;
}
...
for ($i=1; $i<=$jmlhalaman; $i++){
  ...
  $link_halaman .= "<a href=halbiodata-$i.html>$i</a> | ";
}
$link_halaman .= " ";
}
return $link_halaman;
...
// Fungsi untuk mencek halaman dan posisi data
function cariPosisi($batas){
if(empty($_GET[halprofil])){
	$posisi=0;
	$_GET[halprofil]=1;
}
else{
	$posisi = ($_GET[halprofil]-1) * $batas;
}
return $posisi;
}
...
for ($i=1; $i<=$jmlhalaman; $i++){
  ...
  $link_halaman .= "<a href=halprofil-$i.html>$i</a> | ";
}
$link_halaman .= " ";
}
return $link_halaman;
...
// Fungsi untuk mencek halaman dan posisi data
function cariPosisi($batas){
if(empty($_GET[haldok])){
	$posisi=0;
	$_GET[haldok]=1;
}
else{
	$posisi = ($_GET[haldok]-1) * $batas;
}
return $posisi;
}
...
for ($i=1; $i<=$jmlhalaman; $i++){
  ...
  $link_halaman .= "<a href=haldok-$i.html>$i</a> | ";
}
$link_halaman .= " ";
}
return $link_halaman;

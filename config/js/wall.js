...
{
var tentangval = $("#tentang").val();

var updateval = $("#update").val();
//var dataString = 'update='+ updateval;
var dataString = 'update='+ updateval+'&tentang='+tentangval;
//var dataString_tentang = '//update='+ updateval+'tentang='+tentangval;



if(updateval==''||tentangval=='')
{
alert("Silahkan isi Subject dan isi Informasi");
}
else
{
$("#flash").show();

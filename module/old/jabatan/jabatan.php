...
<div class="row">
                        <div class="col-md-12">
                            ...
                            ?>
                               ...
                               <a href="?module=jabatan&act=tambahjabatan" class="btn btn-info  btn-sm"><i class="fa fa-plus-circle"></i> Tambah Data </a>
                                    ...
                                    <table id="example" class="table table-striped responsive-utilities jambo_table data">
									   ...
									   $no=1;
             							...
             							?>
                                        <td class="td-actions">
                                            <a href="?module=jabatan&act=editjabatan&id=<?php echo"$r[id_jabatan]";?>"; class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                                            <a <?php echo"onClick=\"return confirm ('Apakah Anda Yakin ingin Menghapus  $r[nama_jabatan]')\"    href=?module=jabatan&act=hapus&id=$r[id_jabatan]"; ?> class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                                        </td>
                                        <?php
										echo"</tr>";
      									$no++;
  ...
  document.location='?module=masterdata&submenu=jabatan&act=tambahjabatan';
  </script>
  <?php 
  ...
  document.location='?module=jabatan';
  </script>
  <?php 

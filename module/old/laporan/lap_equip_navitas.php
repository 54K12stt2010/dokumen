...
<div class="col-md--12">
  <div class="x_panel">
    <div class="x_title">
      <h2>Laporan Equipment Navitas </h2>
      <div class="clearfix"></div>
    </div>
    <div class="x_content">
      <br />
      <form  id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="cetak/excel_navitas_equip.php" >

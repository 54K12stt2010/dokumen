...
<div class="x_content">
	...
	switch($swap_act){
		...
		<a href="?module=master&menu=m_admin&act=tambahoperator" class="btn btn-info  btn-sm"><i class="fa fa-plus-circle"></i> Tambah Data </a>
		...
		<table class="table table-striped responsive-utilities jambo_table data">
			...
			<tbody>
				...
				while ($r=mysqli_fetch_array($tampil,MYSQLI_ASSOC)){
					...
					?>
					<td class="td-actions">
						<a href="?module=master&menu=m_admin&act=editoperator&id=<?php echo"$r[username]";?>"; class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
						<a <?php echo"onClick=\"return confirm ('Apakah Anda Yakin ingin Menghapus  $r[nama_lengkap]')\"    href=?module=master&menu=m_admin&act=hapus&id=$r[username]"; ?> class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
					</td>
					<?php
					echo"</tr>";
					$no++;
...
if(isset($_POST['simpan'])){
	...
	if($h>0){
		...
		<script type="application/javascript">
			...
			document.location='?module=master&menu=m_admin&act=tambahoperator';
		</script>
		<?php 
		...
		mysqli_query($con,"INSERT INTO operator(username,
			...
			<script type="application/javascript">
				...
				document.location='?module=master&menu=m_admin';
			</script>
			<?php 

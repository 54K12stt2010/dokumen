                                        ...
                                        <div class="col-md-55">
                                            <div class="thumbnail">
                                                <div class="image view view-first">
                                                    <a href="dashboard.php?module=detail_daftarisi&standart=<?php echo"$r[id_standart]&daftar_isi=1"; ?>"><img  style="width: 100%; display: block;" src="images/daftarisi.jpg" alt="image" /></a>
                                                </div>
                                                <div class="caption">

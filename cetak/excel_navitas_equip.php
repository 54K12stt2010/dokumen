...
$objPHPExcel->getActiveSheet()
 ->setCellValue('A8', "NO")
 ->setCellValue('B8', "KODE RCC")
 ->setCellValue('C8', "NAMA SYSTEM")
 ->setCellValue('D8', "DESKRIPSI");
 

$SQL = mysqli_query($con,"SELECT * FROM `equipment_navitas` ");
...
$objPHPExcel->getActiveSheet()->getStyle('A8:D8')->getFill()->getStartColor()->setARGB('FF808080');
...
$objPHPExcel->getActiveSheet()->setSharedStyle($sharedStyle1, "A8:D$nox");
...
$objPHPExcel->getActiveSheet()->setCellValue('C2', "LAPORAN DATA EQUIPMENT NAVITAS ");
...
$objPHPExcel->getActiveSheet()->getStyle('C2:D5')->getFont()->setName('Arial');
$objPHPExcel->getActiveSheet()->getStyle('C2:D2')->getFont()->setSize(16);
...
$objPHPExcel->getActiveSheet()->getStyle('C2:D5')->getFont()->setBold(true);
$objPHPExcel->getActiveSheet()->getStyle('A2:D5')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
